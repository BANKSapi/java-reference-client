...
public class TestAuthData {
    ...
    final static String ADMIN_CLIENT_USERNAME = "tenant/adminClientName";
    final static String ADMIN_CLIENT_PASSWORD = "verysecret";

    final static String USERNAME = "johnDoe";
    final static String PASSWORD = "verysecret";
